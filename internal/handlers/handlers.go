...
import (
	...
	dbrepo "github.com/Soyaib10/comfort-cocoon/repoisitory/dbRepo"
)
...
type Repository struct {
	...
	DB  repoisitory.DatabaseRepo
}

// NewRepo creates a new repository
func NewRepo(a *config.AppConfig, db *repoisitory.DB) *Repository {
	return &Repository{
		App: a,
		DB:  dbrepo.NewMySqlDBRepo(db.DB, a),
	}
}
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	http.Redirect(w, r, "/reservaition-summary", http.StatusSeeOther)
}
...
func (m *Repository) ReservationSummary(w http.ResponseWriter, r *http.Request) {
	...
	if !ok {
		m.App.ErrorLog.Println("Can't error from session")
